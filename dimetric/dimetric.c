...
/// TODO: "port" to xlib and test "smooth" movement with velocities.
...
const double paint_interval_millisec = 1000.0/fps;  // Minimum amount of elapsed time before repaint.
...
int main(int argc, char *argv[])
{
  ...
  GtkWidget *darea;
  gint width, height;
  glob.image = cairo_image_surface_create_from_png("lisplogo.png");
  glob.background_image = cairo_image_surface_create_from_png("scifi-texture.png");
